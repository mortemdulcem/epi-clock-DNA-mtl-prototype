...
- **Sentetik kannabinoidler, MDMA/ecstasy, ketamin:** halka açık metilasyon verisi **yok**
  → hiçbir sayı üretilemez.
...
- **Alkol için saf (sigaradan arındırılmış) etki:** mevcut kohortta sigara değişkeni yok.
...
atıldı, yayın sayıları kaynak gösterildi). Makalede atıf verilen 14 kaynağın tamamı canlı
doğrulanıp uydurma/yanlış-etiketli olduğu gösterildi. Hiçbir sayı
